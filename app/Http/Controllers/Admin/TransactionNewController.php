...
class TransactionNewController extends Controller
{
    public function index()
    {
        ...
        return view('admin.transaction.index-new', compact('productTransactions', 'products'));
    }
    ...
    public function pay(Request $request)
    {
        ...
        try {
            ...
            return view('admin.report.report-transaction', compact('transactionn','productTransactions'));
        } catch (\Exception $e) {
            $var = response()->json([
                'message' => 'Gagal',
